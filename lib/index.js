...
class Service {
  ...
  create (raw, params) {
    ...
    if (this.validateCreate) {
      if (!this.validateCreate(data)) throw new Error('Data failed validation', this.validateCreate.errors);
    }
    ...
    return ids
      .then(idList => {
        ...
        if (this.validatePatch) {
          if (!this.validatePatch(data)) throw new Error('Data failed validation', this.validatePatch.errors);
        }
